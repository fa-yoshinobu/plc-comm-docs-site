---
description: "PLC-side Ethernet settings for the MELSEC MX-F built-in CPU port used with SLMP."
---
...
=== ".NET (C#)"
    ...
    var options = new SlmpConnectionOptions(
        "192.168.250.100", SlmpPlcProfile.MxF, 1025,
