---
description: "PLC-side settings for the MELSEC QJ71E71-100 Ethernet communication unit used with SLMP."
---
...
Use the QJ71E71-100 when the Q series CPU does not have a built-in Ethernet port.
The Ethernet unit profiles use 4E frames with Q/L compatibility; choose the
canonical profile that matches the connected CPU generation.
...
=== ".NET (C#)"
    ...
    var options = new SlmpConnectionOptions("192.168.250.100", SlmpPlcProfile.QnUDVQj71E71100) { Port = 1025 };
