...
| SLMP | C++ (Arduino/PlatformIO) | [plc-comm-slmp-cpp-minimal](https://github.com/fa-yoshinobu/plc-comm-slmp-cpp-minimal) | PlatformIO: `fa-yoshinobu/slmp-connect-cpp-minimal` | `fa-yoshinobu/slmp-connect-cpp-minimal@^3.1.0` |
...
| MC Protocol Serial | C++ (Arduino/PlatformIO) | [plc-comm-mcprotocol-serial-cpp](https://github.com/fa-yoshinobu/plc-comm-mcprotocol-serial-cpp) | PlatformIO: `fa-yoshinobu/mcprotocol-serial-cpp` | `fa-yoshinobu/mcprotocol-serial-cpp@^3.1.0` |
