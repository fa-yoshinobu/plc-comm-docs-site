...
| MC Protocol Serial | C++ (Arduino/PlatformIO) | [plc-comm-mcprotocol-serial-cpp](https://github.com/fa-yoshinobu/plc-comm-mcprotocol-serial-cpp) | PlatformIO: `fa-yoshinobu/mcprotocol-serial-cpp` | `fa-yoshinobu/mcprotocol-serial-cpp@^3.0.1` |
